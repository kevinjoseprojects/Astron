...
import React, { useEffect, useRef, } from '\x72\x65\x61\x63\x74';
import { createNoise3D, } from '\x73\x69\x6d\x70\x6c\x65\x78\x2d\x6e\x6f\x69\x73\x65';
...
const particlePropsLength = particleCount *
particlePropCount;
const rangeY = props
.rangeY ||
100;
...
.baseSpeed ||
0.0;
const rangeSpeed = props
.rangeSpeed ||
1.5;
const baseRadius = props
.baseRadius ||
1;
const rangeRadius = props
.rangeRadius ||
2;
const baseHue = props
.baseHue ||
...
let particleProps = new Float32Array(
particlePropsLength,
);
let center = [
0,
...
const initParticles = () => {
tick = 0;
particleProps = new Float32Array(
particlePropsLength,
);
...
<div
className={cn(
'\x72\x65\x6c\x61\x74\x69\x76\x65\x20\x68\x2d\x66\x75\x6c\x6c\x20\x77\x2d\x66\x75\x6c\x6c',
props
.containerClassName,
)}
>
...
<div
className={cn(
'\x72\x65\x6c\x61\x74\x69\x76\x65\x20\x7a\x2d\x31\x30',
props
.className,
)}
>
